...
parser = argparse.ArgumentParser(description="Train single CVAE for a specified split.")
...
CONFIG = {
    ...
    "CHECKPOINT_DIR": f"outputs_{SPLIT}_single_cvae_20250524",
    "IMG_SIZE": (360, 203),
    "BATCH_SIZE": 1,  # Set to 1 to avoid OOM issues
    "LATENT_DIM": 4,
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(f"/home/sanderwald/Projects/dissertationProject/train_single_cvae_{SPLIT}.log"),
...
if gpus:
    for gpu in gpus:
        ...
        tf.config.experimental.set_virtual_device_configuration(
            gpu,
            [tf.config.experimental.VirtualDeviceConfiguration(memory_limit=6000)]  # Reduced from 8000 to 6000
        )
    ...
    try:
        ...
        for epoch in range(1, CONFIG["EPOCHS"] + 1):
            ...
            for x_batch, y_batch in train_dataset:
                ...
                total_kl_loss += batch_kl_loss / CONFIG["NUM_CVAES"]
                total_focal_loss += batch_focal_loss / CONFIG["NUM_CVAES"]
                if batch_count % 100 == 0:  # Changed from 500 to 100
